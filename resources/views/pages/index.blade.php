...
@section('content')
    <div class="dashboard__inner__item__left bodyItemPadding">
                ...
                <div class="dashboard__inner__header__right">
                    <div class="dashboard__inner__item__right recent_activities">
                        <div class="btn-wrapper">
                            <a href="javascript:void(0)" class="cmn_btn btn_small radius-5" id="activity_btn">Show
                                Activities</a>
                        </div>
                                        ...
                                        <div class="dashboard__recentActivities__single__flex">
                                            <div class="dashboard__recentActivities__single__thumb">
                                                <a href="javascript:void(0)"><img
                                                        src="assets/img/recent_activities/activities1.jpg"
                                                        alt="activities"></a>
                                            </div>
                                            <div class="dashboard__recentActivities__single__contents">
                                                <h6 class="dashboard__recentActivities__single__title">
                                                    <a href="javascript:void(0)">Gown
                                                        party wear is sold 01 piece</a>
                                                </h6>
                                                <p class="dashboard__recentActivities__single__time mt-2">
                                                    10 Min ago</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="dashboard__recentActivities__item">
                                    <div class="dashboard__recentActivities__single">
                                        <div class="dashboard__recentActivities__single__flex">
                                            <div class="dashboard__recentActivities__single__thumb">
                                                <a href="javascript:void(0)"><img
                                                        src="assets/img/recent_activities/activities2.jpg"
                                                        alt="activities"></a>
                                            </div>
                                            <div class="dashboard__recentActivities__single__contents">
                                                <h6 class="dashboard__recentActivities__single__title">
                                ...
                                <div class="dashboard__recentActivities__item">
                                    <div class="dashboard__recentActivities__single">
                                        <div class="dashboard__recentActivities__single__flex">
                                            <div class="dashboard__recentActivities__single__thumb">
                                                <a href="javascript:void(0)"><img
                                                        src="assets/img/recent_activities/activities3.jpg"
                                                        alt="activities"></a>
                                            </div>
                                            <div class="dashboard__recentActivities__single__contents">
                                                <h6 class="dashboard__recentActivities__single__title">
                                ...
                                <div class="dashboard__recentActivities__item">
                                    <div class="dashboard__recentActivities__single">
                                        <div class="dashboard__recentActivities__single__flex">
                                            <div class="dashboard__recentActivities__single__thumb">
                                                <a href="javascript:void(0)"><img
                                                        src="assets/img/recent_activities/activities4.jpg"
                                                        alt="activities"></a>
                                            </div>
                                            <div class="dashboard__recentActivities__single__contents">
                                                <h6 class="dashboard__recentActivities__single__title">
                                ...
                                <div class="dashboard__recentActivities__item">
                                    <div class="dashboard__recentActivities__single">
                                        <div class="dashboard__recentActivities__single__flex">
                                            <div class="dashboard__recentActivities__single__thumb">
                                                <a href="javascript:void(0)"><img
                                                        src="assets/img/recent_activities/activities5.jpg"
                                                        alt="activities"></a>
                                            </div>
                                            <div class="dashboard__recentActivities__single__contents">
                                                <h6 class="dashboard__recentActivities__single__title">
        ...
        <div class="alert alert-danger mt-4 rounded-2 fw-bold">Please review the README
            file to fully understand your task.
        </div>
            ...
            <div class="row g-4 mt-2">
                <div class="col-xxl-3 col-xl-4 col-sm-6">
                    <div class="dashboard_promo__single bg__white radius-10 padding-20">
                        ...
                        <p class="dashboard_promo__single__para mt-3"><span class="percentage"> +20%</span> Than last month
                        </p>
                    </div>
                </div>
                <div class="col-xxl-3 col-xl-4 col-sm-6">
                    <div class="dashboard_promo__single bg__white radius-10 padding-20">
                        ...
                        <p class="dashboard_promo__single__para mt-3"><span class="percentage">+19%</span> Than last month
                        </p>
                    </div>
                </div>
                <div class="col-xxl-3 col-xl-4 col-sm-6">
                    <div class="dashboard_promo__single bg__white radius-10 padding-20">
                        ...
                        <p class="dashboard_promo__single__para mt-3"><span class="percentage"> +08%</span> Than last month
                        </p>
                    </div>
                </div>
                <div class="col-xxl-3 col-xl-4 col-sm-6">
                    <div class="dashboard_promo__single bg__white radius-10 padding-20">
                        ...
                        <p class="dashboard_promo__single__para mt-3"><span class="percentage percentDown"> -12%</span>
                            Than last
                            month</p>
                    </div>
                </div>
